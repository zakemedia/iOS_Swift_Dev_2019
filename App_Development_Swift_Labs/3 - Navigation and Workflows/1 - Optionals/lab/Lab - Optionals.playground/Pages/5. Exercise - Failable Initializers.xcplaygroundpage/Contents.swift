 ...
 */
if let computer1 = Computer(ram: 1, yearManufactured: 1980) {
    print("Computer's Ram: \(computer1.ram) and was Manufactured: \(computer1.yearManufactured)")
}

if let computer2 = Computer(ram: 2, yearManufactured: 2018) {
    print("Computer's Ram: \(computer2.ram) and was Manufactured: \(computer2.yearManufactured)")
} // nil
